...
const UNKNOWN_BLOCK_NAME: &'static str = "?UNKNOWN_BLOCK?";
pub const MISSING: Block = Block { name: UNKNOWN_BLOCK_NAME };
...
with open('test.rs','w') as f:
    for i in range(4096):
        print('"%s",' % (UNKNOWN_BLOCK_NAME if i not in d else "minecraft:"+d[i]), file=f)
```
*/
